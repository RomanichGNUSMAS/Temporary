...
function openTab(typeOfTab) {
    ...
    switch (typeOfTab) {
        ...
        case "Compiler": {
            ...
            contentDiv.style.cssText = `width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; position: fixed;`;
            ...
            compileBtn.style.cssText = `position: fixed; right: 5.5px; bottom: 1.5%; width: 8%; height: 91%; padding: 0px 15px; background: rgba(19, 96, 50, 0.57); backdrop-filter: blur(25px) saturate(150%); -webkit-backdrop-filter: blur(25px) saturate(150%); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3), inset 0 1px 1px rgba(255, 255, 255, 0.35), inset 0 -1px 1px rgba(0, 0, 0, 0.15); color: rgba(255, 255, 255, 0.95); border: 1px solid rgba(82, 139, 255, 0.45); border-radius: 24px; font-family: "Samsung Sharp Sans", sans-serif; font-weight: bold; cursor: pointer; letter-spacing: 0.5px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1); z-index: 10; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.6);`;

            compileBtn.onmouseover = () => { compileBtn.style.background = 'rgba(101, 76, 203, 0.69)'; compileBtn.style.transform = 'translateY(-2px)'; compileBtn.style.boxShadow = `0 15px 35px rgba(0, 0, 0, 0.4), inset 0 1px 2px rgba(255, 255, 255, 0.45), inset 0 -1px 1px rgba(0, 0, 0, 0.2)`; compileBtn.style.borderColor = 'rgba(82, 139, 255, 0.7)'; };
            compileBtn.onmouseout = () => { compileBtn.style.background = 'rgba(19, 96, 50, 0.57)'; compileBtn.style.transform = 'translateY(0px)'; compileBtn.style.boxShadow = `0 10px 30px rgba(0, 0, 0, 0.3), inset 0 1px 1px rgba(255, 255, 255, 0.35), inset 0 -1px 1px rgba(0, 0, 0, 0.15)`; compileBtn.style.borderColor = 'rgba(82, 139, 255, 0.45)'; };
            compileBtn.onmousedown = () => { compileBtn.style.transform = 'translateY(1px) scale(0.98)'; compileBtn.style.background = 'rgba(82, 139, 255, 0.18)'; compileBtn.style.boxShadow = `0 5px 15px rgba(0, 0, 0, 0.2), inset 0 2px 4px rgba(0, 0, 0, 0.25), inset 0 1px 1px rgba(255, 255, 255, 0.2)`; };
            compileBtn.onmouseup = () => { compileBtn.style.transform = 'translateY(-2px) scale(1)'; compileBtn.style.background = 'rgba(82, 139, 255, 0.34)'; };
